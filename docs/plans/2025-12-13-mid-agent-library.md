# Mid-Agent Library Implementation Plan
...
## How Mid-Agent Differs from Fantasy

| Aspect | Fantasy | Mid-Agent |
|--------|---------|-----------|
...
**Key Differentiator:** Fantasy answers "how do I call different LLMs?" Mid-Agent answers "how do I build a robust agentic system with tools, permissions, and orchestration?"
...
```bash
cd /Users/harper/Public/src/2389/mid-agent
go mod init github.com/2389-research/mid-agent
```
...
go get github.com/2389-research/mid-agent
...
git commit -m "chore: initialize mid-agent module"
```
...
import (
	...
	"github.com/2389-research/mid-agent/tool"
)
...
import (
	...
	"github.com/2389-research/mid-agent/llm"
)
...
// ABOUTME: mid-agent to work with any LLM provider (Anthropic, OpenAI, etc.)
package llm
...
import (
	...
	"github.com/2389-research/mid-agent/orchestrator"
)
...
import (
	...
	"github.com/2389-research/mid-agent/mcp"
)
...
// ABOUTME: the mid-agent Tool interface for seamless integration.
package mcp
...
import (
	...
	"github.com/2389-research/mid-agent/permission"
)
...
// ABOUTME: Demonstrates basic mid-agent usage - creating a simple agent
...
```go
// integration_test.go
// ABOUTME: Integration tests verifying the full mid-agent stack works
...
This plan creates a **mid-agent** library with:
...
1. Add mid-agent as dependency
2. Implement `llm.Client` for their provider
3. Replace `internal/tools` with `mid-agent/tool`
4. Replace `internal/mcp` with `mid-agent/mcp`
5. Replace agent loop with `mid-agent/orchestrator`

---

**Plan complete and saved to `docs/plans/2025-12-13-mid-agent-library.md`. Two execution options:**
